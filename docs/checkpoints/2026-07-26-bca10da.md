...
> **Status: HISTORICAL**
>
> Frozen checkpoint snapshot, preserved as found on 2026-09-12.
>
> - Last content change: `bca10da`, 2026-07-26.
> - The body below describes itself as the checkpoint for `a4a1664`, but the
>   file received later edits in `97d71b6`, `ae8ebe0`, and `bca10da`. Its text,
>   including a sentence broken by one of those edits, is preserved exactly and
>   has not been repaired.
> - This snapshot is not current authority. Current implementation truth lives
>   in [`docs/CURRENT_IMPLEMENTATION_CHECKPOINT.md`](../CURRENT_IMPLEMENTATION_CHECKPOINT.md).
>   Document authority is defined in
